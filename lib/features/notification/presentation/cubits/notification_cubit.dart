...
class NotificationCubit extends Cubit<NotificationState> {
  ...
  Future<void> loadNotifications() async {
    try {
      ...
      print(
          '🔔 NotificationCubit: Emitted NotificationLoading state successfully');
      ...
      try {
        ...
        _notificationsSubscription = _firestore
          ...
          if (error.toString().contains('PERMISSION_DENIED')) {
            print(
                'Permissions denied for notifications collection stream, falling back to order data');
        ...
        if (e.toString().contains('PERMISSION_DENIED')) {
          print(
              'Permissions denied for notifications collection, falling back to order data');
        ...
        try {
          ...
          if (status != null && createdAt != null) {
            ...
            if (normalizedStatus == 'dispatched' ||
              ...
              print(
                  '✅ Added dispatched notification for order $orderId (read: $isRead)');
              ...
              notifications.add(NotificationEntity(
                ...
                message:
                    'Your order #$orderId has been successfully delivered. Enjoy your fresh vegetables!',
              ...
              print(
                  '✅ Added delivered notification for order $orderId (read: $isRead)');
            } else {
              print(
                  '❌ Order $orderId has status: "$status" (normalized: "$normalizedStatus")');
              print(
                  '   Expected statuses: "dispatched" or "delivered" (case-insensitive)');
            }
          } else {
  ...
  Future<void> markAsRead(String notificationId) async {
    print(
        '🔔 NotificationCubit: Marking notification as read: $notificationId');
  ...
  Future<void> _markNotificationAsRead(String notificationId) async {
    ...
    if (!readNotifications.contains(notificationId)) {
      ...
      print(
          '🔔 NotificationCubit: Persisted read notification: $notificationId');
    }
  }
  ...
  Future<void> _markAllNotificationsAsRead(List<String> notificationIds) async {
    ...
    print(
        '🔔 NotificationCubit: Persisted all ${notificationIds.length} notifications as read');
  }
